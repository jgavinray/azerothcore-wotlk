...
#ifndef AZEROTHCORE_MOCKWORLD_H
#define AZEROTHCORE_MOCKWORLD_H
...
/**
 * @brief Mock for World class
 *
 * Provides a mock implementation of World for unit testing.
 * Usage:
 *   MockWorld world;
 *   WHEN(world, GetActiveSessionCount()).WillOnce(Return(0));
 */
...
public:
    ...
    MOCK_METHOD(void, ProcessCliCommand, (CliCommandHolder* commandHolder), ());
